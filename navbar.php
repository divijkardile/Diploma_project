...
<head>
  ...
  <link href="autocomplete/jquery.auto-complete.css" rel="stylesheet">
...
<div class="wrapper" style="background-color:#4663b9;">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="active treeview">
          <a href="admin_dashboard.php" style="background-color:#4663b9;">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
				<li><a href="admininfo.php"><i class="fa fa-info "></i>&nbsp;Admin Information</a></li>
		...
		<li class="treeview">
          ...
          <ul class="treeview-menu">
				<li><a href="custinfo.php"><i class="fa fa-info "></i>&nbsp;Customer Information</a></li>
				
           </ul>		     
		     <ul class="treeview-menu">
				<li><a href="vehicledtl.php"><i class="fa fa-info "></i>&nbsp;Vehicle Information</a></li>
				
           </ul>
		     <ul class="treeview-menu">
				<li><a href="insurancedtl.php"><i class="fa fa-info "></i>&nbsp;Insurance Information</a></li>
