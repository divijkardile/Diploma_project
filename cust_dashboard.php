							...
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										...
										<div><a href="personalinfo.php"><font color="white" size="5">Personal Info</font></a></div>
									</div>
								</div>
							</div>
							...
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										...
										<div><a href="vehicleinfo.php"><font color="white" size="5">Vehicle Details</font></a></div>
									</div>
								</div>
							</div>
							...
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-xs-9 text-right">
										...
										<div><a href="insuranceinfo.php"><font color="white" size="5">Insurance Details</font></a></div>
									</div>
								</div>
							</div>
							<a href="insuranceinfo.php">
								<div class="panel-footer" style="color:#397BB6">
									<b><span class="pull-left">View Detail</span>
									<span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span></b>
									<div class="clearfix"></div>
