		...
		<div class="row" style="margin-left:5px;margin-right:25px;margin-top:0px;">
					<div class="col-lg-11 col-md-11" align="center" style="border:px solid black;">					
							...
							<div class="col-lg-5" align="right" style="border:px solid black;margin-top:px;">
								...
								<h2>	
								<input type="text" name="custname" id="custname" size="11" class="input-lg" placeholder="Enter Customer Name">
		...
		<script>		   
				...
				function saveForm() {
					...
					$('button.edit').on('click', function() {
						...
						$(this).parentsUntil('div[id=col]').find('input,select').each(function(i) {
							formVal[i] = $(this).val();
				...
				$('#custname').autoComplete({
					...
					source: function(term, response)
					{
						...
						xhr = $.getJSON('searchcustname.php', { q : term }, function(data){ response(data); });
					}
				});
			});			
